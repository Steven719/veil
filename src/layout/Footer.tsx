...
function App() {
  return (
    <div>
      <footer class="c-footer border-1 border-top position-relative pb-5 pb-md-3 pt-3 pt-sm-5 mt-0">
        <div class="my-lg-5 container">
          <div class="row justify-content-center align-items-center my-3 my-lg-5 gx-4 gx-xl-0 gy-4 gy-lg-0">
            <div class="col-12 col-md-12 col-lg-3 d-flex flex-row justify-content-center justify-content-lg-start">
              <a
                class="c-footer__logo d-flex flex-row justify-content-center"
                href="#"
              >
                <img
                  alt="Veil Brand Icon"
                  ...
                  src={logo}
                />
                <p class="fs-4 ms-2">Veil</p>
              </a>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-6">
              <div class="d-flex flex-column flex-sm-row text-center align-items-center justify-content-center w-100 gap-0 gap-sm-4 list-group">
                <div class="mb-1 border-0 bg-transparent list-group-item">
                ...
                <div class="border-0 bg-transparent list-group-item">
            ...
            <div class="col-12 col-md-12 col-lg-3 d-flex flex-row justify-content-center align-items-center justify-content-lg-end gap-3">
              <a
          ...
          <div class="d-flex flex-column flex-md-row justify-content-center justify-content-md-between align-items-center mt-3 mt-lg-5 pt-3 pt-lg-5 border-1 border-top">
            <div class="d-flex flex-column flex-md-row justify-content-center justify-content-start gap-3 gap-md-4 mb-3 mb-md-0">
              <a class="text-muted" href="/tos">
                Terms of Service
              </a>
            </div>
